...
public class HuTietKiemActivity extends AppCompatActivity implements TransactionAdapter.OnItemClickListener, ItemOptionsBottomSheet.OnUserActionListener{
    ...
    ImageView back;
    TextView txtSoTienTietKiem,txtTongTienRut,txtTongTienNap,txtThangNam,txtThangNam1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hu_tiet_kiem);
        getSupportActionBar().hide();
        back = findViewById(R.id.back);

        txtSoTienTietKiem = findViewById(R.id.txtTienTietKiem);
        ...
        incomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HuTietKiemActivity.this,ThuNhapTungHuActivity.class);
                intent.putExtra("tenHu","Hũ tiết kiệm");
        ...
        spendingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuTietKiemActivity.this,ChiTieuTungHuActivity.class);
                intent.putExtra("tenHu","Hũ tiết kiệm");
                startActivity(intent);
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuTietKiemActivity.this,HomeActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        collectionReference2.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(HuTietKiemActivity.this));
                    transactionAdapter = new TransactionAdapter(HuTietKiemActivity.this, listGiaoDich);
                    transactionAdapter.setOnItemClickListener(HuTietKiemActivity.this);
    ...
    private void showMonthYearPicker() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(HuTietKiemActivity.this);
...
// Animate chart
    ...
    public void onUpdate(GiaoDichNap giaoDichNap) {
        ...
        Intent intent = new Intent(HuTietKiemActivity.this,ChinhSuaGiaoDichActivity.class);
    ...
    public void onDelete(GiaoDichNap giaoDichNap) {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(HuTietKiemActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HuTietKiemActivity.this, "Xóa không thành công", Toast.LENGTH_SHORT).show();
            }
        });
