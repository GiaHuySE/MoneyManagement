...
public class HuDauTuActivity extends AppCompatActivity implements TransactionAdapter.OnItemClickListener, ItemOptionsBottomSheet.OnUserActionListener{
    FirebaseFirestore firestore;
    FirebaseAuth mAuth = FirebaseAuth.getInstance();
    FirebaseUser currentUser = mAuth.getCurrentUser();
    Button buttonChuyenHu, buttonChinhHu;
    ImageView back;
    TextView txtSoTienDauTu,txtTongTienRut,txtTongTienNap,txtThangNam,txtThangNam1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hu_dau_tu);
        getSupportActionBar().hide();

        back = findViewById(R.id.back);
        txtSoTienDauTu = findViewById(R.id.txtTienDauTu);
       ...
       // layoutThangNam = findViewById(R.id.layoutThangNam);
        ...
        incomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HuDauTuActivity.this,ThuNhapTungHuActivity.class);
                intent.putExtra("tenHu","Hũ đầu tư");
        ...
        spendingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuDauTuActivity.this,ChiTieuTungHuActivity.class);
                intent.putExtra("tenHu","Hũ đầu tư");
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuDauTuActivity.this,HomeActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        collectionReference2.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(HuDauTuActivity.this));
                    transactionAdapter = new TransactionAdapter(HuDauTuActivity.this, listGiaoDich);
                    transactionAdapter.setOnItemClickListener(HuDauTuActivity.this);
    ...
    private void showMonthYearPicker() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(HuDauTuActivity.this);
...
// Animate chart
    ...
    public void onUpdate(GiaoDichNap giaoDichNap) {
        ...
        Intent intent = new Intent(HuDauTuActivity.this,ChinhSuaGiaoDichActivity.class);
    ...
    public void onDelete(GiaoDichNap giaoDichNap) {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(HuDauTuActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HuDauTuActivity.this, "Xóa không thành công", Toast.LENGTH_SHORT).show();
            }
        });
                                                    ...
                                                    if (documentSnapshot.exists()) {
                                                        ...
                                                        for (String key : tienRutInfo.keySet()) {
                                                            ...
                                                            if (value instanceof Map) {
                                                                ...
                                                                if (monthWord.equals(monthName.toLowerCase()) && year == yearPicker && tenHu.equals("Hũ đầu tư")) {
                                                                    String id = (String) mapValue.get("uuid");
                                                                    Double soTien = (Double) mapValue.get("tienNap");
                                                                    String loaiGiaoDich = (String) mapValue.get("loaiGiaoDich");
                                                                    String moTa = (String) mapValue.get("moTa");
