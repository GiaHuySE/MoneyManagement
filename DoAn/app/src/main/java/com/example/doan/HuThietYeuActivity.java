...
public class HuThietYeuActivity extends AppCompatActivity implements TransactionAdapter.OnItemClickListener, ItemOptionsBottomSheet.OnUserActionListener {
    ...
    ImageView back;
    TextView txtSoTienThietYeu, txtTongTienRut, txtTongTienNap, txtThangNam, txtThangNam1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hu_thiet_yeu);
        // requestWindowFeature(Window.FEATURE_NO_TITLE);
        getSupportActionBar().hide();

        back = findViewById(R.id.back);
        txtSoTienThietYeu = findViewById(R.id.txtTienThietYeu);
        ...
        incomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HuThietYeuActivity.this, ThuNhapTungHuActivity.class);
                intent.putExtra("tenHu", "Hũ thiết yếu");
        ...
        spendingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuThietYeuActivity.this, ChiTieuTungHuActivity.class);
                intent.putExtra("tenHu", "Hũ thiết yếu");
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuThietYeuActivity.this, HomeActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        collectionReference2.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(HuThietYeuActivity.this));
                    transactionAdapter = new TransactionAdapter(HuThietYeuActivity.this, listGiaoDich);
                    transactionAdapter.setOnItemClickListener(HuThietYeuActivity.this);
    ...
    private void showMonthYearPicker() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(HuThietYeuActivity.this);
...
// Animate chart
    ...
    public void onUpdate(GiaoDichNap giaoDichNap) {
        ...
        Intent intent = new Intent(HuThietYeuActivity.this, ChinhSuaGiaoDichActivity.class);
    ...
    public void onDelete(GiaoDichNap giaoDichNap) {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(HuThietYeuActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HuThietYeuActivity.this, "Xóa không thành công", Toast.LENGTH_SHORT).show();
            }
        });
                                                    ...
                                                    if (documentSnapshot.exists()) {
                                                        ...
                                                        for (String key : tienRutInfo.keySet()) {
                                                            ...
                                                            if (value instanceof Map) {
                                                                ...
                                                                if (monthWord.equals(monthName.toLowerCase()) && year == yearPicker && tenHu.equals("Hũ thiết yếu")) {
                                                                    String id = (String) mapValue.get("uuid");
                                                                    //String tenHu = (String) mapValue.get("tenHu");
                                                                    Double soTien = (Double) mapValue.get("tienNap");
                                                                    String loaiGiaoDich = (String) mapValue.get("loaiGiaoDich");
