...
public class HuGiaoDucActivity extends AppCompatActivity implements TransactionAdapter.OnItemClickListener, ItemOptionsBottomSheet.OnUserActionListener{
    ...
    ImageView back;
    TextView txtSoTienGiaoDuc,txtTongTienRut,txtTongTienNap,txtThangNam,txtThangNam1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hu_giao_duc);
        getSupportActionBar().hide();

        back = findViewById(R.id.back);
        txtSoTienGiaoDuc = findViewById(R.id.txtTienGiaoDuc);
       ...
       // layoutThangNam = findViewById(R.id.layoutThangNam);
        ...
        incomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HuGiaoDucActivity.this,ThuNhapTungHuActivity.class);
                intent.putExtra("tenHu","Hũ giáo dục");
        ...
        spendingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuGiaoDucActivity.this,ChiTieuTungHuActivity.class);
                intent.putExtra("tenHu","Hũ giáo dục");
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuGiaoDucActivity.this,HomeActivity.class);
                startActivity(intent);
            }
        });
...
//        buttonChuyenHu.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(HuGiaoDucActivity.this, ChuyenHuActivity.class);
//                startActivity(intent);
//            }
//        });
//
...
//                            Intent intent = new Intent(HuGiaoDucActivity.this, ChinhHuActivity.class);
...
//        });
        ...
        collectionReference2.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(HuGiaoDucActivity.this));
                    transactionAdapter = new TransactionAdapter(HuGiaoDucActivity.this, listGiaoDich);
                    transactionAdapter.setOnItemClickListener(HuGiaoDucActivity.this);
    ...
    private void showMonthYearPicker() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(HuGiaoDucActivity.this);
    ...
    public void onUpdate(GiaoDichNap giaoDichNap) {
        ...
        Intent intent = new Intent(HuGiaoDucActivity.this,ChinhSuaGiaoDichActivity.class);
    ...
    public void onDelete(GiaoDichNap giaoDichNap) {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(HuGiaoDucActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HuGiaoDucActivity.this, "Xóa không thành công", Toast.LENGTH_SHORT).show();
            }
        });
                                                    ...
                                                    if (documentSnapshot.exists()) {
                                                        ...
                                                        for (String key : tienRutInfo.keySet()) {
                                                            ...
                                                            if (value instanceof Map) {
                                                                ...
                                                                String monthWord = months[month].toLowerCase();
                                                                String tenHu = (String) mapValue.get("tenHu");
                                                                if (monthWord.equals(monthName.toLowerCase()) && year == yearPicker && tenHu.equals("Hũ giáo dục")) {
                                                                    String id = (String) mapValue.get("uuid");
...
//                                        Log.d("key: ", key);
                                        ...
                                        if (value instanceof Map) {
                                            ...
                                            int month = Integer.parseInt(parts[1]);
                                            int yearPicker = Integer.parseInt(parts[2]);
                                            Log.d("onComplete: ", String.valueOf(yearPicker));
                                            String[] months = new String[]{"", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
                                            String monthWord = months[month].toLowerCase();
                                            String tenHu = (String) mapValue.get("tenHu");
                                            if (monthWord.equals(monthName.toLowerCase()) && year == yearPicker && tenHu.equals(hu)) {
