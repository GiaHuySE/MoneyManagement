...
public class HuThienTamActivity extends AppCompatActivity implements TransactionAdapter.OnItemClickListener, ItemOptionsBottomSheet.OnUserActionListener{
    FirebaseFirestore firestore;
    FirebaseAuth mAuth = FirebaseAuth.getInstance();
    FirebaseUser currentUser = mAuth.getCurrentUser();
    Button buttonChuyenHu, buttonChinhHu;
    ImageView back;
    TextView txtSoTienThienTam,txtTongTienRut,txtTongTienNap,txtThangNam,txtThangNam1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hu_thien_tam);
        getSupportActionBar().hide();

        back = findViewById(R.id.back);
        txtSoTienThienTam = findViewById(R.id.txtTienThienTam);
        ...
        incomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HuThienTamActivity.this,ThuNhapTungHuActivity.class);
                intent.putExtra("tenHu","Hũ thiện tâm");
        ...
        spendingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuThienTamActivity.this,ChiTieuTungHuActivity.class);
                intent.putExtra("tenHu","Hũ thiện tâm");
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HuThienTamActivity.this,HomeActivity.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(HuThienTamActivity.this, ChuyenHuActivity.class);
//                startActivity(intent);
//            }
//        });
//
...
//                            Intent intent = new Intent(HuThienTamActivity.this, ChinhHuActivity.class);
...
//        });
        ...
        collectionReference2.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(HuThienTamActivity.this));
                    transactionAdapter = new TransactionAdapter(HuThienTamActivity.this, listGiaoDich);
                    transactionAdapter.setOnItemClickListener(HuThienTamActivity.this);
    ...
    private void showMonthYearPicker() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(HuThienTamActivity.this);
...
// Animate chart
    ...
    public void onUpdate(GiaoDichNap giaoDichNap) {
        ...
        Intent intent = new Intent(HuThienTamActivity.this,ChinhSuaGiaoDichActivity.class);
    ...
    public void onDelete(GiaoDichNap giaoDichNap) {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(HuThienTamActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HuThienTamActivity.this, "Xóa không thành công", Toast.LENGTH_SHORT).show();
            }
        });
                                                    ...
                                                    if (documentSnapshot.exists()) {
                                                        ...
                                                        for (String key : tienRutInfo.keySet()) {
                                                            ...
                                                            if (value instanceof Map) {
                                                                ...
                                                                if (monthWord.equals(monthName.toLowerCase()) && year == yearPicker && tenHu.equals("Hũ thiện tâm")) {
                                                                    String id = (String) mapValue.get("uuid");
                                                                    Double soTien = (Double) mapValue.get("tienNap");
                                                                    String loaiGiaoDich = (String) mapValue.get("loaiGiaoDich");
                                                                    String moTa = (String) mapValue.get("moTa");
